...
db.define_table( "Menu" , Field("Restaurant_Name",requires = IS_NOT_EMPTY(),unique=True) , Field("Item_Name",requires = IS_NOT_EMPTY(),unique=True) , Field("Price",requires = IS_NOT_EMPTY()))

#db.Restaurant.Restaurant_Name.requires = IS_NOT_EMPTY()
#db.Restaurant.number.requires = IS_INT_IN_RANGE(minimum = 1000000000,maximum = 9999999999)
